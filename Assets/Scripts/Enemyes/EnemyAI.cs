...
public class EnemyAI : MonoBehaviour
{
    ...
    [SerializeField] private float chasingSpeedMutltiplier = 2f;
    ...
    private void Awake()
    {
        ...
        roamingSpeed = agent.speed;
        chasingSpeed = agent.speed * chasingSpeedMutltiplier;
    }
    ...
    {
        return agent.speed / roamingSpeed;
    }
